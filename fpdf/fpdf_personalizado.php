...
function Header()
{
	$this->Image('../files/imagenes/logo-report.png',11,8,32,12);
	...
	//$this->Cell(40);
	if($this->CurOrientation=='L'){
		$this->Cell(110,11,str_repeat('_',140),0,0,'L');
		$this->Cell(166,10,utf8_decode('Sistema Integrado de Gestión'),0,0,'R');
		$this->Ln(6);
	}else{
		$this->Cell(110,11,str_repeat('_',97),0,0,'L');
		$this->Cell(82,10,utf8_decode('Sistema Integrado de Gestión'),0,0,'R');
		$this->Ln(2);
	}	
}
...
function Footer()
{
	...
	$this->Cell(100,10,date('d/m/Y h:i:s A'),0,0,'L');
