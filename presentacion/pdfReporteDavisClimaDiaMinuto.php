...
$pdf->Cell(30,$alto,"FECHA Y HORA",1,0,'C',1);
$pdf->Cell(30,$alto,utf8_decode("TEMP.(°C)"),1,0,'C',1);
$pdf->Cell(30,$alto,utf8_decode("HUME.(%)"),1,0,'C',1);
$pdf->Cell(30,$alto,utf8_decode("V.V.(m/s)"),1,0,'C',1);
$pdf->Cell(35,$alto,utf8_decode("PRECI.(m3)"),1,0,'C',1);
$pdf->Cell(35,$alto,utf8_decode("RAD. SOLAR(W/s)"),1,0,'C',1);
$i=1;
$pdf->SetFont('Arial','',8);
$pdf->Ln();
...
foreach($data as $k=>$fila){
    ...
    $pdf->Cell(30,$alto,formatoCortoFechaHora($fila['fecha']),1,0);
    $pdf->Cell(30,$alto,$fila['temperatura'],1,0,'R',1);
    $pdf->Cell(30,$alto,$fila['humedad_relativa'],1,0,'R',1);
    $pdf->Cell(30,$alto,$fila['velocidad_viento'],1,0,'R',1);
    $pdf->Cell(35,$alto,$fila['precipitacion'],1,0,'R',1);
    $pdf->Cell(35,$alto,$fila['radiacion_solar'],1,0,'R',1);
...
$pdf->Output('I','Reporte_Clima_Minuto.pdf');
?>