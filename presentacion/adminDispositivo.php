		...
		<div class="card card-custom gutter-b">
			<div class="card-header" style="min-height: 50px">
				<div class="card-title">
					...
					<h3 class="card-label">Dispositivo
					<small>Busqueda de Dispositivo</small></h3>
				</div>
			</div>
			<div class="card-body">
				<div class="row">
...
function verPagina<?php echo $sufijo;?>(pagina, loading=1){
	...
	let filtro='estado='+estado+'&nombre='+nombre+'&nivel='+nivel;
	...
	setRun('presentacion/listaDispositivo',filtro+extra+extrapermiso,'divLista<?php echo $sufijo;?>','divLista<?php echo $sufijo;?>',loading);	
}

verPagina<?php echo $sufijo;?>(1,0);

function NuevoRegistro<?= $sufijo ?>(){
	ViewModal('presentacion/mantDispositivo','accion=NUEVO&idopcion=<?= $idopcion ?>&nivel=<?= $nivel + 1 ?>','divmodal1','Registro Dispositivo',0);
}
