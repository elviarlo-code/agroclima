		...
		<div class="card card-custom gutter-b">
			<div class="card-header" style="min-height: 50px">
				<div class="card-title">
					...
					<small>Busqueda de Perfil</small></h3>
				</div>
			</div>
			<div class="card-body">
				<div class="row">
...
function verPagina<?php echo $sufijo;?>(pagina, loading=1){
	...
	let filtro='estado='+estado+'&descripcion='+descripcion+'&nivel='+nivel;
	...
	setRun('presentacion/listaPerfil',filtro+extra+extrapermiso,'divLista<?php echo $sufijo;?>','divLista<?php echo $sufijo;?>',loading);	
}

verPagina<?php echo $sufijo;?>(1,0);

function NuevoRegistro<?= $sufijo ?>(){
	ViewModal('presentacion/mantPerfil','accion=NUEVO&idopcion=<?= $idopcion ?>&nivel=<?= $nivel + 1 ?>','divmodalmediano','Registrar Perfil',0);
}
