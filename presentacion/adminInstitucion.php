		...
		<div class="card card-custom gutter-b">
			<div class="card-header" style="min-height: 50px">
				<div class="card-title">
					...
					<h3 class="card-label">Institución
					<small>Busqueda de Institución</small></h3>
				</div>
			</div>
			<div class="card-body">
				<div class="row">
					<div class="col-md-4">
						<div class="input-group input-group-sm">
							<div class="input-group-prepend">
								<span class="input-group-text font-weight-bolder">Institucion</span>
							</div>
					...
					<div class="col-md-4">
						<div class="input-group input-group-sm">
							<div class="input-group-prepend">
								<span class="input-group-text font-weight-bolder">RUC</span>
							</div>
...
function verPagina<?php echo $sufijo;?>(pagina, loading=1){
	...
	let filtro='estado='+estado+'&nombre='+nombre+'&documento='+documento+'&nivel='+nivel;
	...
	setRun('presentacion/listaInstitucion',filtro+extra+extrapermiso,'divLista<?php echo $sufijo;?>','divLista<?php echo $sufijo;?>',loading);	
}

verPagina<?php echo $sufijo;?>(1,0);

function NuevoRegistro<?= $sufijo ?>(){
	ViewModal('presentacion/mantInstitucion','accion=NUEVO&idopcion=<?= $idopcion ?>&nivel=<?= $nivel + 1 ?>','divmodal<?= $nivel ?>','Registrar Institución',0);
}
