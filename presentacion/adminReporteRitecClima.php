...
$listaDispositivo = $objCase->getListTableFiltroSimple('dispositivo', 'estado', 'N', 'tipo', 'RITEC01C');
...
function verPagina<?php echo $sufijo;?>(pagina, loading=1, actual=0){
    ...
    if(listar=='D'){
        setRun('presentacion/listaReporteRitecClimaDia',filtro+extra+extrapermiso,'divLista<?php echo $sufijo;?>','divLista<?php echo $sufijo;?>',loading); 
    }else if(listar=='M'){
        setRun('presentacion/listaReporteRitecClimaMes',filtro+extra+extrapermiso,'divLista<?php echo $sufijo;?>','divLista<?php echo $sufijo;?>',loading); 
    }else if(listar=='A'){
        setRun('presentacion/listaReporteRitecClimaAnio',filtro+extra+extrapermiso,'divLista<?php echo $sufijo;?>','divLista<?php echo $sufijo;?>',loading); 
    }
}
...
function ExportarDataExcel<?= $sufijo ?>(){
    ...
    if(listar=='D'){
        if(frecuencia=='M'){
            window.open('presentacion/xlsReporteRitecClimaDiaMinuto.php?'+filtro+extra+extrapermiso,'_blank');
        }else{
            window.open('presentacion/xlsReporteRitecClimaDia.php?'+filtro+extra+extrapermiso,'_blank');
        }
    }else if(listar=='M'){
        window.open('presentacion/xlsReporteRitecClimaMes.php?'+filtro+extra+extrapermiso,'_blank');
    }else if(listar=='A'){
        window.open('presentacion/xlsReporteRitecClimaAnio.php?'+filtro+extra+extrapermiso,'_blank');
    }
...
function ExportarDataPDF<?= $sufijo ?>(){
    ...
    if(listar=='D'){
        if(frecuencia=='M'){
            window.open('presentacion/pdfReporteRitecClimaDiaMinuto.php?'+filtro+extra+extrapermiso,"_blank", 'width = 600, height = 500');
        }else{
            window.open('presentacion/pdfReporteRitecClimaDia.php?'+filtro+extra+extrapermiso,"_blank", 'width = 600, height = 500');
        }
    }else if(listar=='M'){
        window.open('presentacion/pdfReporteRitecClimaMes.php?'+filtro+extra+extrapermiso,"_blank", 'width = 600, height = 500');
    }else if(listar=='A'){
        window.open('presentacion/pdfReporteRitecClimaAnio.php?'+filtro+extra+extrapermiso,"_blank", 'width = 600, height = 500');
    }
}
