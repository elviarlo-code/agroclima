...
$data = $objRep->consultarDatosSensorPorMes($iddispositivo, $anio, $mes);
...
function agregarImagenConControlEspacio($pdf, $rutaImagen, $x, &$y, $ancho, $alto, $margenInferior = 5) {
    ...
    if ($alturaDisponible < $alto) {
        $pdf->AddPage('P','A4'); // Agregar nueva página si no hay espacio
...
$imagenes = [
    ...
    "../files/imagenes/grafico_Viento_{$sufijo}{$iddispositivo}.png",
...
$pdf->Cell(30,$alto,"FECHA",1,0,'C',1);
$pdf->Cell(22,$alto,utf8_decode("TEMP. MIN"),1,0,'C',1);
$pdf->Cell(22,$alto,utf8_decode("TEMP. PRO"),1,0,'C',1);
$pdf->Cell(22,$alto,utf8_decode("TEMP. MAX"),1,0,'C',1);
$pdf->Cell(22,$alto,utf8_decode("HUMD. MIN"),1,0,'C',1);
$pdf->Cell(22,$alto,utf8_decode("HUMD. PRO"),1,0,'C',1);
$pdf->Cell(22,$alto,utf8_decode("HUMD. MAX"),1,0,'C',1);
$pdf->Cell(22,$alto,utf8_decode("V.V. MIN"),1,0,'C',1);
$pdf->Cell(22,$alto,utf8_decode("V.V. PRO"),1,0,'C',1);
$pdf->Cell(22,$alto,utf8_decode("V.V. MAX"),1,0,'C',1);
$pdf->Cell(23.5,$alto,utf8_decode("PRECIPITACION"),1,0,'C',1);
$pdf->Cell(23.5,$alto,utf8_decode("RAD.SOLAR"),1,0,'C',1);
$i=1;
$pdf->SetFont('Arial','',8);
$pdf->Ln();
...
foreach($data as $k=>$fila){
    ...
    $pdf->Cell(30,$alto,formatoCortoFecha($fila['fecha']),1,0,'C');
    $pdf->Cell(22,$alto,$fila['tempmin'],1,0,'R',1);
    $pdf->Cell(22,$alto,$fila['temppro'],1,0,'R',1);
    $pdf->Cell(22,$alto,$fila['tempmax'],1,0,'R',1);
    $pdf->Cell(22,$alto,$fila['hummin'],1,0,'R',1);
    $pdf->Cell(22,$alto,$fila['humpro'],1,0,'R',1);
    $pdf->Cell(22,$alto,$fila['hummax'],1,0,'R',1);
    $pdf->Cell(22,$alto,$fila['vvemin'],1,0,'R',1);
    $pdf->Cell(22,$alto,$fila['vvepro'],1,0,'R',1);
    $pdf->Cell(22,$alto,$fila['vvemax'],1,0,'R',1);
    $pdf->Cell(23.5,$alto,$fila['precipitacion'],1,0,'R',1);
    $pdf->Cell(23.5,$alto,$fila['radiacion_solar'],1,0,'R',1);
...
$pdf->Output('I','Reporte_Clima_Dia.pdf');
?>