...
if($_GET['accion']=='MODIFICAR'){
	...
	$registro = $objCase->getRowTableById('campania_fenologia',$id,'idfenologia');
}
...
function registrar<?= $sufijo ?>(){
	if(verificarFormulario<?= $sufijo ?>()){
		...
		<?php if($_GET['accion']=="NUEVO"){ ?>
			datax.push({name: "accion",value:"NUEVA_FENOLOGIA_CAMPANIA"});
		<?php }else{ ?>
			datax.push({name: "accion",value:"MODIFICAR_FENOLOGIA_CAMPANIA"});
		<?php } ?>
