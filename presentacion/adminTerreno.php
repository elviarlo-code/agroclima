		...
		<div class="card card-custom gutter-b">
			<div class="card-header" style="min-height: 50px">
				<div class="card-title">
					...
					<h3 class="card-label">Terreno
					<small>Busqueda de Terreno</small></h3>
				</div>
			</div>
			<div class="card-body">
				<div class="row">
...
function verPagina<?php echo $sufijo;?>(pagina, loading=1){
	...
	setRun('presentacion/listaTerreno',filtro+extra+extrapermiso,'divLista<?php echo $sufijo;?>','divLista<?php echo $sufijo;?>',loading);	
}

verPagina<?php echo $sufijo;?>(1,0);

function NuevoRegistro<?= $sufijo ?>(){
	ViewModal('presentacion/mantTerreno','accion=NUEVO&idopcion=<?= $idopcion ?>&nivel=<?= $nivel + 1 ?>','divmodal1','Registro de Terreno',0);
}
